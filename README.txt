...
In our shell.c, we treat string input as its literall form meaning we do not parse input in quotes, for example the cmd: echo "hello world" will output  "hello world"  if you want just, hello world you would have to issue the cmd: echo hello world. 
